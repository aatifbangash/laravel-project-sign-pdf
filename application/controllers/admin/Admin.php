		...
		if ($this->input->post('submit')) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($result) {
					...
					$message = "Hello [name]!\r\nYour account has been successfully created on [website]. For questions, please contact [admin-email].\r\n\r\nThank you!";

					$message = str_replace('[name]', $this->input->post('email'), $message);
					...
					$this->email->subject('Your account has been created on esignaturepdf.com');
